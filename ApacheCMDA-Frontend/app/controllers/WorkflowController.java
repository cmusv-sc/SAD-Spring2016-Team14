...
public class WorkflowController extends Controller {
    ...
    public static Result addComment(Long wid) {
        ...
        System.out.println("adding comment now");
        ...
        //USE DECORATOR DESIGN PATTERN TO ADD COMMENT
        CommentWorkflowDecorator commentDecorator = new CommentWorkflowDecorator();
        JsonNode commentResponse = commentDecorator.create(jnode);
    ...
    public static Result addReply(long toUserId, long commentId, long wid) {
        ...
        ObjectMapper mapper = new ObjectMapper();
        ObjectNode jnode = mapper.createObjectNode();
        System.out.println("adding reply to comment now");
        try {
