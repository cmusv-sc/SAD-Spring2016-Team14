...
public class GroupController extends play.mvc.Controller {
    ...
    public static Result create()
    {
        ...
        // here use Builder Pattern
//        GroupBuilder gb = new ConcreteGroupBuilder();
//        GroupDirector gd = new GroupDirector(gb);
        GroupBuilder gb;
        GroupDirector gd;
        for (JsonNode n: response) {
            gb = new ConcreteGroupBuilder();
            gd = new GroupDirector(gb);
            Group g = gd.construct(n);
            groupArr.add(g);
        }
