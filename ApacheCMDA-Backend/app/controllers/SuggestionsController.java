...
//        Suggestions suggestions = new Suggestions(userID, suggestionContent,suggestionAndWorkflow);
        ...
        Suggestions suggestions= (Suggestions)af.getAttachment("suggestion");
        suggestions.setSuggestionCreator(userID);
        suggestions.setSuggestionContent(suggestionContent);
        suggestions.setSuggestionWorkflows(suggestionAndWorkflow);
